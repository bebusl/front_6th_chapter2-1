import"./modulepreload-polyfill-B5Qt9EMX.js";const $=50,E=5,f=0,O=.2,B=.05,T="p1",I="p2",C="p3",D="p4",q="p5",V=[{id:T,name:"버그 없애는 키보드",discountValue:1e4,originalVal:1e4,quantity:50,onSale:!1,suggestSale:!1},{id:I,name:"생산성 폭발 마우스",discountValue:2e4,originalVal:2e4,quantity:30,onSale:!1,suggestSale:!1},{id:C,name:"거북목 탈출 모니터암",discountValue:3e4,originalVal:3e4,quantity:20,onSale:!1,suggestSale:!1},{id:D,name:"에러 방지 노트북 파우치",discountValue:15e3,originalVal:15e3,quantity:0,onSale:!1,suggestSale:!1},{id:q,name:"코딩할 때 듣는 Lo-Fi 스피커",discountValue:25e3,originalVal:25e3,quantity:10,onSale:!1,suggestSale:!1}];class b{static#e;#t=[];constructor(){if(b.#e)return b.#e;b.#e=this}setProducts(t){this.#t=t}changeQuantity(t,a){const n=this.#t.find(o=>o.id===t);if(!n)throw new Error(`Product with id "${t}" not found`);const s=n.quantity+a;s>=0&&(n.quantity=s)}getProducts(){return this.#t}getProductCount(){return this.#t.length}getProductById(t){const a=this.#t.find(n=>n.id===t);if(!a)throw Error("해당하는 상품이 없습니다.");return a}getProductAt(t){if(t<0||t>=this.#t.length)throw new RangeError(`index ${t} is out of bounds (0 ~ ${this.#t.length-1})`);return this.#t[t]}getTotalStock(){if(!this.#t)throw Error();return this.#t.reduce((t,a)=>t+a.quantity,0)}isLowTotalStock(){return this.getTotalStock()<$}getLowStockMessages(){return this.#t.filter(t=>t.quantity<E).map(t=>t.quantity>f?`${t.name}: 재고 부족 (${t.quantity}개 남음)`:`${t.name}: 품절`).join(`
